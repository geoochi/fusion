...
export const opmlAPI = {
  ...
  // Downloads an OPML file generated by the backend and saves it to disk.
  export: async (filename = "fusion-subscriptions.opml"): Promise<void> => {
    const response = await fetch(`${API_BASE}/opml/export`, {
      method: "GET",
      credentials: "include",
    });
